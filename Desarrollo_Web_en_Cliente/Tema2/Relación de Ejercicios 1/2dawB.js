// Esta función realiza una división entre dos números ingresados por el usuario y muestra el resultado en la página web.
function dividirNumeros() {
    ...
    // Realiza la operación de división entre los dos números.
